...
import com.abhimangal.videocamerwithfilter.widget.Filters;
import com.abhimangal.videocamerwithfilter.widget.SampleGLView;
    ...
    protected void onCreateActivity() {
        ...
        recordBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (recordBtn.getText().equals(BaseCameraActivity.this.getString(R.string.app_record))) {
                    filepath = getVideoFilePath();
                    cameraRecorder.start(filepath);
                    recordBtn.setText("Stop");
                } else {
                    cameraRecorder.stop();
                    recordBtn.setText(BaseCameraActivity.this.getString(R.string.app_record));
                }
